  ...
  return (
    <section className="py-16 px-6 sm:px-10 lg:px-20 rounded-sm  text-center mt-10">
      ...
      <form className="mt-6 flex flex-col sm:flex-row justify-center items-center gap-3 max-w-xl mx-auto" onSubmit={onSubmitHandler}>
        ...
        <button
          type="submit"
          className="bg-amber-500 text-white px-6 py-3 rounded-md sm:rounded-l-none sm:rounded-r-md font-semibold hover:bg-amber-600 transition-all duration-300 shadow-md w-full sm:w-auto"
        >
          Subscribe
        </button>
      </form>
